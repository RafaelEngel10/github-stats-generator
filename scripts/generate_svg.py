...
def render_svg(username, user, summary):
    ...
    svg = f'''<svg xmlns="http://www.w3.org/2000/svg" width="540" height="120" viewBox="0 0 540 120">
        ...
        <g transform="translate(20,20)">
            <text x="0" y="0" fill="#0f7d7e">{username}</text>
            ...
            <g transform="translate(0,48)">
                ...
                <text x="0" y="28" fill="#baffff">Top languages: {top_langs_str}</text>
                <text x="0" y="46" fill="#baffff">Followers: {user.get('followers', 0)} &#8226; Updated: {now}</text>
            </g>
        </g>
    </svg>'''
    return svg
